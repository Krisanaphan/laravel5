      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="name" name="name" type="text" value="{{ old('name') ? old('name') : $item->name }}" aria-describedby="nameHelp" placeholder="Enter first name">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" type="text" value="{{ old('surname') ? old('surname') : $item->surname }}" aria-describedby="nameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="mobile" name="mobile" type="text" value="{{ old('mobile') ? old('mobile') : $item->mobile }}" aria-describedby="nameHelp" placeholder="Enter mobile">


          </div>
          <div class="col-md-6">
            <label for="age">Age</label>
            <input class="form-control" id="age" name="age" value="{{ old('age') ? old('age') : $item->age }}" type="text" aria-describedby="nameHelp" placeholder="Enter age">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="address" name="address" value="{{ old('address') ? old('address') : $item->address }}" type="text" aria-describedby="nameHelp" placeholder="Enter address">
